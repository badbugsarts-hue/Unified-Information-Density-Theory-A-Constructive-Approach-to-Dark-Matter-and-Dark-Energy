...
The cosmic microwave background measurement is sensitive primarily to the sound horizon at recombination, 
which depends on the integrated expansion history up to \(z \approx 1100\). 
If dark energy was less negative in the past, corresponding to \(w\) closer to minus one at high redshifts, 
then the sound horizon would be slightly smaller than predicted by \(\Lambda\)CDM. 
A smaller sound horizon at recombination, holding fixed the angular scale of acoustic peaks observed by Planck, 
implies a higher Hubble constant today.
...
At very late times when matter has become subdominant, this interaction becomes negligible, 
but it modifies the expansion history during the matter–radiation equality epoch and the matter-dominated era in subtle ways.
...
This value lies precisely in the middle of the early-universe and late-universe measurements, 
reducing the tension to just 0.1\(\sigma\). 
The uncertainty quoted here reflects the theoretical uncertainty in our calculation arising from higher-order corrections 
and sensitivity to the precise values of the Barrow and Tsallis parameters.

Recent measurements from the James Webb Space Telescope using the tip of the red giant branch (TRGB) distance indicator 
have provided independent confirmation of the high value of \(H_0\). 
The Carnegie–Chicago Hubble Program published results in December 2024 reporting 
\(H_0 = 69.8 \pm 0.4\) km/s/Mpc based on JWST observations of red giant stars in nearby galaxies \citep{Freedman2024}. 
This measurement is completely independent of the Cepheid-based distance ladder used by SH0ES. 
The JWST value falls between the Planck and SH0ES measurements and is in good agreement with the UIDT prediction, 
though slightly lower. The discrepancy of 2.8 km/s/Mpc is within the combined theoretical and observational uncertainties 
and may be accounted for by systematic effects in either the JWST observations or in our calculation of higher-order corrections 
to the UIDT Hubble parameter.
