...
with \( w_0 = -0.98 \pm 0.02 \) and \( w_a = 0.12 \pm 0.04 \), where \( a \) is the scale factor. This predicts a slight deviation from \( w = -1 \), testable with future surveys like Euclid~\cite{
}.
