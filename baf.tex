...
\[
\mathcal{L}_{\text{int}} = -\frac{\kappa}{\Lambda} S(x) \, \mathrm{Tr}(F_{\mu\nu} F^{\mu\nu}),
\]
...
in excellent agreement with independent lattice QCD calculations reporting \(1.710 \pm 0.080\,\text{GeV}\) for the lightest scalar glueball state~\citep{Durr2008}. 
