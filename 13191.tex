...
is typically modeled as a cosmological constant \(\Lambda\) in the standard \(\Lambda\)CDM framework, 
...
large-scale structure surveys, and supernova distance measurements.
...
and the formation of cosmic structure, yet it evades direct detection in terrestrial experiments. 
...
weakly interacting massive particles, axions, or other hypothetical dark matter constituents. 
...
within the standard model. The \(S_8\) tension, a similar discrepancy between cosmic microwave background predictions and weak gravitational lensing 
measurements of matter clustering, adds further strain to the \(\Lambda\)CDM framework.
...
We implement this through Barrow--Tsallis hybrid entropy, a generalization of the Bekenstein--Hawking entropy formula 
that incorporates both fractal quantum gravity corrections parametrized by a Barrow index \(\Delta\) 
...
Euclid Quick Release 1, JWST distance measurements, and ACT polarization data. 
